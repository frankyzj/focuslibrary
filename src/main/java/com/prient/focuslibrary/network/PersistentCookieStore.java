...
public class PersistentCookieStore implements CookieStore {
    ...
    private void loadAllFromPersistence() {
        ...
        for (Map.Entry<String, ?> entry : prefsMap.entrySet()) {
            ...
            try {
                ...
                String encodeCookie = (String) entry.getValue();
                HttpCookie cookie = new SerializableHttpCookie().decode(encodeCookie);
    ...
    private void saveToPersistence(URI uri, HttpCookie cookie) {
        ...
        prefsWriter.putString(uri.toString() + SP_KEY_DELIMITER + cookie.getName(),
